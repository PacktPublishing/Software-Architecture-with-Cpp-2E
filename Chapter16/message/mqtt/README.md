...
In the basic configuration, authentication and TLS encryption are not configured. Just run the MQTT server:

```bash
docker compose up -d
```

[MQTT Explorer](https://mqtt-explorer.com/) is a powerful tool for monitoring and debugging MQTT networks.
